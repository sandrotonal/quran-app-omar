...
function AppContent() {
    ...
    // Initialize dark mode and handle theme color based on splash status
    useEffect(() => {
        // 'dark' sınıfını dinamik olarak state ile senkronize et
        document.documentElement.classList.toggle('dark', isDark);

        // Splash bitene kadar meta theme-color index.html'deki #070f1a da kalsın
        // Splash bittikten sonra asıl tema rengine geçsin
        if (!showSplash) {
